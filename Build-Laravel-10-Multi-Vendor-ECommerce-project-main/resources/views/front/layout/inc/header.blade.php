            ...
            <div class="row">
                <div class="col-xxl-3 d-xxl-block d-none">
                    <div class="top-left-header">
                        ...
                        <span class="text-white">1418 Riverwood Drive,
                            CA 96052, US</span>
                    </div>
                </div>
                        ...
                        <div class="notification-slider">
                            <div>
                                <div class="timer-notification">
                                    <h6>
                                        <strong class="me-1">Welcome to
                                            Shopedia Shop!</strong>
                                        where you'll find great prices
                                        for best unique products.<strong class="ms-1">Try Hot Coupon
                                            Code: IJAB056X
                                        </strong>
                            ...
                            <div>
                                <div class="timer-notification">
                                    <h6>New Arrivals: The Latest
                                        Keyboards & MIDIs, Yamaha and
                                        Many More
                                        <a href="javascript:void(0)" class="text-white">Buy
                                            Now</a>
                                    </h6>
                                </div>
                            </div>
                        ...
                        <li class="right-nav-list">
                            <div class="dropdown theme-form-select">
                                <button class="btn dropdown-toggle" type="button" id="select-language"
                                    ...
                                    <img src="/front/images/country/united-states.png" class="img-fluid blur-up lazyload"
                                        alt>
                                    <span>English</span>
                                </button>
                                <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="select-language">
                                    <li>
                                        <a class="dropdown-item" href="javascript:void(0)" id="english">
                                            <img src="/front/images/country/united-kingdom.png"
                                    ...
                                    <li>
                                        <a class="dropdown-item" href="javascript:void(0)" id="france">
                                            <img src="/front/images/country/germany.png" class="img-fluid blur-up lazyload"
                                                alt>
                                            <span>Germany</span>
                                        </a>
                                    </li>
                                    <li>
                                        <a class="dropdown-item" href="javascript:void(0)" id="chinese">
                                            <img src="/front/images/country/turkish.png" class="img-fluid blur-up lazyload"
                                                alt>
                                            <span>Turki</span>
                                        </a>
                                    </li>
        ...
        <div class="container-fluid-lg">
            <div class="row">
                                ...
                                <div class="input-group">
                                    <form action="/search" method="POST">
                                        <input type="search" class="form-control"
                                            placeholder="What are you looking for?" aria-describedby="button-addon2" name="searched">
                                        <a href="/search">
                            ...
                            <ul class="right-side-menu">
                                ...
                                <li class="right-side">
                                    <a href="contact-us.html" class="delivery-login-box">
                                        <div class="delivery-icon">
                                            <i class="ShopediaIcon icon-copy dw dw-phone-call"></i>
                                        </div>
                                ...
                                <li class="right-side">
                                    <a href="wishlist.html" class="btn p-0 position-relative header-wishlist">
                                        <i class="ShopediaIcon icon-copy ti-heart"></i>
                                    </a>
                                </li>
                                <li class="right-side">
                                    <div class="onhover-dropdown header-badge">
                                        <button type="button" class="btn p-0 position-relative header-wishlist">
                                            <i class="ShopediaIcon icon-copy dw dw-shopping-cart2"></i>
                                ...
                                <li class="right-side onhover-dropdown">
                                    <div class="delivery-login-box">
                                        <div class="delivery-icon">
                                            ...
                                            <i class="ShopediaIcon icon-copy dw dw-user-1"></i>
                ...
                <ul class="user-box-name">
                    <li class="product-box-contain">
                        <a href="/seller/login"><i class="icon-copy dw dw-login"></i> Sign In</a>
                    </li>
                    <li class="product-box-contain">
                        <a href="/seller/register"><i class="icon-copy dw dw-user-2"></i> Register</a>
                    </li>
                    <li class="product-box-contain">
                        <a href="/seller/register"><i class="icon-copy dw dw-user-2"></i> Be a Seller</a>
                    </li>
                </ul>
            </div>
                                </li>
                ...
                <div class="header-nav">
                    <div class="header-nav-left">
                        <button class="dropdown-category">
                            <i class="ShopediaIcon icon-copy bi bi-list-nested "></i>
                        ...
                        <div class="main-nav navbar navbar-expand-xl navbar-light navbar-sticky">
                            <div class="offcanvas offcanvas-collapse order-xl-2" id="primaryMenu">
                                ...
                                <div class="offcanvas-body">
                                    <ul class="navbar-nav Shopedia-nav">
